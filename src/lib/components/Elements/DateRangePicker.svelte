...
<style lang="postcss">
  ...
  .button-container {
    @apply flex items-center justify-end ml-auto pl-1;
  }

  [data-melt-popover-content] {
    @apply z-10 w-[320px] max-w-full rounded-lg bg-neutral-900 shadow-sm;
  }
  ...
  [data-melt-datefield-field] {
    @apply mt-1.5 flex w-full flex-wrap items-center rounded-lg border border-magnum-400/60 bg-neutral-800/80 p-1.5 text-magnum-400;
  }
