...
{#if replyTag}
  {#if !loadNote}
    <button
      class="my-1 flex items-center w-fit px-1 py-0.5 max-w-full rounded-md text-sm border border-magnum-500 text-magnum-300 hover:opacity-75 active:opacity-50 overflow-hidden h-fit"
  ...
  {:else}
    <button
      class="my-1 flex items-center w-fit px-1 py-0.5 rounded-md text-sm border border-magnum-500 text-magnum-300 hover:opacity-75 active:opacity-50 overflow-hidden max-w-full h-fit"
