...
<style lang="postcss">
  ...
  .h5,
  .h6 {
    @apply font-title tracking-wide font-semibold;
    /* border-bottom: dashed 1px theme(colors.magnum.400/0.5); */
  }

  .h1 {
    @apply text-4xl md:text-5xl mt-8 mb-4;
  }

  .h2 {
    @apply text-3xl md:text-4xl mt-8 mb-4;
  }
  ...
  .h4 {
    @apply text-xl md:text-2xl mt-6 mb-4;
  }
