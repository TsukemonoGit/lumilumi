...
{#if viewIndex !== 0}
  <div class="w-full" bind:this={headerElement}>
    <button
      class="w-full rounded-md bg-magnum-600 py-2 flex justify-center items-center font-bold text-lg text-magnum-100 gap-2 my-1 myButton"
    ...
    <button
      disabled={$nowProgress}
      class="rounded-md bg-magnum-600 w-full py-2 flex justify-center items-center font-bold text-lg text-magnum-100 gap-2 my-1 myButton"
      onclick={() => handlePrev()}
    >
