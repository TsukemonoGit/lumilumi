<script lang="ts">
  ...
  const tabIds = triggers.map((t) => t.id);
      ...
      >
        ...
        >
          {#each triggers as triggerItem}
            <button
              {...tabs.getTrigger(triggerItem.id)}
