    ...
    <li>
      ...
      <div class="item">
        ...
        <button
          ...
          data-relays="wss://nostr.mutinywallet.com,wss://relay.nostr.wirednet.jp"
      ...
      <div class="item">
        <ul class="list-disc ml-4 space-y-1">
          <li>
            {$_("features.bookmark")}
            <br />
            {$_("features.bookmarkLink.before")}
            <a
              href="https://shosai.lumilumi.app/"
              target="_blank"
              rel="noopener noreferrer"
              class="text-blue-500 underline"
            >
              shosai.lumilumi.app</a
            >
            {$_("features.bookmarkLink.after")}
          </li>
        </ul>
      </div>
    </li>
